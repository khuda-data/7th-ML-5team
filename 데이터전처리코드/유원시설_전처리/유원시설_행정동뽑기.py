...
# 2️⃣ CSV 파일 로드
file_path = r"C:\Users\82102\Desktop\토이프로젝트\데이터 전처리\유원시설.csv"
output_file_path = r"C:\Users\82102\Desktop\토이프로젝트\데이터 전처리\유원시설_행정동추가.csv"
...
for index, row in df.iterrows():
    x, y = row["FCLTY_LO"], row["FCLTY_LA"]  # 경도, 위도
