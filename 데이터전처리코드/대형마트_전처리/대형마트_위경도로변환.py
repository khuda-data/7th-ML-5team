...
# 2️⃣ CSV 파일 로드
file_path = r"C:\Users\82102\Desktop\토이프로젝트\raw data\대형마트_필터링.csv"
...
# 3️⃣ 주소 → 좌표 변환 실행 (지번주소 또는 도로명주소 사용)
...
output_file_path = r"C:\Users\82102\Desktop\토이프로젝트\raw data\대형마트_좌표.csv"
