...
# 2️⃣ CSV 파일 로드 및 좌표 변환 수행
file_path = r"C:\Users\82102\Desktop\토이프로젝트\데이터 전처리\지하철역.csv"
...
for index, row in df.iterrows():
    address = row["지번주소"]  # '지번주소' 컬럼에서 주소 가져오기
...
output_file_path = r"C:\Users\82102\Desktop\토이프로젝트\데이터 전처리\지하철역_좌표.csv"
