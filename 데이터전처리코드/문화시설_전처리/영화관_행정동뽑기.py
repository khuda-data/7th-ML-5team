...
# 2️⃣ CSV 파일 로드
file_path = r"C:\Users\82102\Desktop\토이프로젝트\데이터 전처리\서울시_영화상영관_좌표추가.csv"
output_file_path = r"C:\Users\82102\Desktop\토이프로젝트\데이터 전처리\서울시_영화상영관_행정동추가.csv"
...
print(f"🎉 2단계 완료! 행정동 변환된 데이터는 {output_file_path} 에 저장됨.")