...
# 2️⃣ CSV 파일 로드
file_path = r"C:\Users\82102\Desktop\토이프로젝트\raw data\어린이집_정상.csv"
...
output_file_path = r"C:\Users\82102\Desktop\토이프로젝트\raw data\어린이집_행정동.csv"
df.to_csv(output_file_path, index=False, encoding="utf-8-sig")

print(f"🎉 변환 완료! 행정동 변환된 데이터는 {output_file_path} 에 저장됨.")